...
export async function GET() {
  try {
    const newsItems = [
      {
        title: "ALAGOAS É DESTAQUE NA PRODUÇÃO DE BIOENERGIA DO NORDESTE",
      ...
      {
        title: "ABERTURA DA SAFRA 2024/25 PROMETE NÚMEROS RECORDE",
    ...
    return NextResponse.json({ success: true, message: '5 real news items seeded successfully' });
  } catch (error: any) {
