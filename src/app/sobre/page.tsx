        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            <div className="space-y-6 relative z-10">
              ...
              <img className="w-full h-48 object-cover rounded-xl grayscale hover:grayscale-0 transition-all duration-500" alt="Histórico" src="/img/fazenda.png" />
            </div>
            ...
            <div className="space-y-6 relative z-10">
              ...
              <img className="w-full h-48 object-cover rounded-xl grayscale hover:grayscale-0 transition-all duration-500" alt="Industrial" src="/img/fazenda.png" />
            </div>
            ...
            <div className="space-y-6 relative z-10">
              ...
              <img className="w-full h-48 object-cover rounded-xl grayscale hover:grayscale-0 transition-all duration-500" alt="Tecnologia" src="/img/fazenda.png" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 px-8 md:px-16 bg-white overflow-hidden">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-20">
          <div className="w-full md:w-1/2 relative">
            ...
            <img className="w-full aspect-[4/5] object-cover rounded-lg shadow-2xl skew-x-[-2deg]" alt="Filosofia" src="/img/filosofiacana.png" />
          </div>
      ...
      <section className="py-32 px-8 md:px-16 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { name: 'Ricardo Alencastro', role: 'CEO & Fundador', img: '/img/homen1.png' },
              { name: 'Dra. Beatriz Mendes', role: 'Diretora de Sustentabilidade', img: '/img/mulher1.png' },
              { name: 'Eng. Marcus Viana', role: 'Diretor de Operações', img: '/img/homen1.png' },
              { name: 'Helena Costa', role: 'Diretora de Tecnologia', img: '/img/mulher1.png' },
            ].map((leader, idx) => (
